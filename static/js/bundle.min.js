...
async function loadHealthDashboard(period) {
    ...
    tbody.innerHTML = sorted.map(item => {
        ...
        return `<tr class="${rowCls}" role="button" tabindex="0" aria-label="View health details" onclick="showHealthDetail('${item.product_id}')" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();showHealthDetail('${item.product_id}')}" style="cursor:pointer">
            <td>${productCell}</td>
