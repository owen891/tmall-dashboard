...
> - v4.0 → v5.0: 新增库存维度、内容维度、品类ROI分析、ROI停投策略、完善生命周期评分
...
| 评分维度 | 扣分规则 | 加分规则 |
|---------|---------|---------|
| ROI | <1.5扣40分，<2.0扣20分 | ≥3.0加10分 |
| 退款率 | >30%扣20分，>15%扣10分 | <5%加5分 |
| 趋势 | 衰退期扣15分 | 成熟期加10分，成长期加5分 |
