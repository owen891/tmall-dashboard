...
class ImportScannerApiTests(unittest.TestCase):
    ...
    def test_crud_and_legacy_schedule_migration_contract(self):
        ...
        removed = self.client.post(f'/api/import-scans/{job_id}/delete', json={})
        self.assertEqual(removed.status_code, 200)
        self.assertTrue(removed.get_json()['data']['deleted'])
        self.assertEqual(self.client.get('/api/import-scans').get_json()['data'], [])
